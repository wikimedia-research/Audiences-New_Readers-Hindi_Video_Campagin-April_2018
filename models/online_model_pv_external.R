...
names(output) <- c('RMSE', 'RMSE_sd', 'MAPE', 'MAPE_sd', 'Rsquare', 'AbsEffect', 'AbsEffect_CI_width', 'AbsEffect_sd', 'contain_zero')
      ...
      # 8.425057e+03       1.961936e+03       7.637637e-02       1.918093e-02       9.506425e-01
      #    AbsEffect AbsEffect_CI_width       AbsEffect_sd       contain_zero
      # 5.022346e+03       1.568953e+04       3.854156e+03       7.785714e-01
...
p <- plot(model_29_impact) +
     labs(title = "Impact of the online campaign in 6 weeks on Hindi Wikipedia externally-referred page views from Madhya Pradesh",
     subtitle = "Vertical dashed line represents the start date of the campaign 3 April 2018")
ggsave("hiwiki_external_pv_online_impact.png", plot = p, path = 'docs/figures', units = "in", dpi = 300, height = 6, width = 14)
summary(model_29_impact)
summary(model_29_impact, "report")
png('docs/figures/hiwiki_external_pv_online_inclusion_prob.png', units = "in", res = 300, height = 8, width = 10)
